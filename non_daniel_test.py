...
start1 = mod.smiles("C=C(C)C(=O)OC")
start2 = mod.smiles("O")
end1 = mod.smiles("C=C(C)C(=O)O")
end2 = mod.smiles("CO")
s1 = ap.termFromGraph(start1)
s2 = ap.termFromGraph(start2)
e1 = ap.termFromGraph(end1)
